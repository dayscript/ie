    ...
    <div id="tabs-1" class="tabs-x">
      <form id="ebscohostCustomSearchBox" action="" onsubmit="return ebscoHostSearchGo(this);" method="post">
        ...
        <input id="ebscohosturl" name="ebscohosturl" type="hidden"
          value="http://search.ebscohost.com/login.aspx?direct=true&site=eds-live&scope=site&type=0&custid=s5094900&groupid=main&profid=eds&mode=bool&lang=es&authtype=cookie,ip" />
        <input id="ebscohostsearchsrc" name="ebscohostsearchsrc" type="hidden" value="db" />
        <input id="ebscohostsearchmode" name="ebscohostsearchmode" type="hidden" value="+" />
        <input id="ebscohostkeywords" name="ebscohostkeywords" type="hidden" value="" />
        <div class="searchArea">
          <input id="ebscohostsearchtext" class="ebscohostsearchtext" name="ebscohostsearchtext" type="text"
            size="50" />
          <button class="submit"><i class="icon-buscar"></i></button>
          <div id="guidedFieldSelectors" class="inline-elements">
            <input class="radio" type="radio" name="searchFieldSelector" id="guidedField_0" value=""
              checked="checked" />
    ...
    <div id="tabs-4" class="tabs-x" style="display:none;">
      <form id="sbPeriodici" action="" onsubmit="return ebscoHostSearchOther(this);" method="post">
        <div class="searchArea">
          <input id="ebscohostwindow" name="ebscohostwindow" type="hidden" value="1" />
          <input id="ebscohosturl" name="ebscohosturl" type="hidden"
            value="http://search.ebscohost.com/login.aspx?direct=true&site=eds-live&scope=site&type=44&db=edspub&custid=s5094900&amp;groupid=main&amp;profid=eds&amp;mode=bool&amp;lang=es&amp;authtype=ip" />
          <input id="ebscohostsearchsrc" name="ebscohostsearchsrc" type="hidden" value="db" />
          <input id="ebscohostsearchmode" name="ebscohostsearchmode" type="hidden" value="+" />
          <input id="ebscohostkeywords" name="ebscohostkeywords" type="hidden" value="" />
          <input id="ebscohostsearchtext" class="ebscohostsearchtext" name="ebscohostsearchtext" type="text" size="50"
            placeholder="<?php echo t('Enter a title, subject or ISSN / ISBN'); ?>" />
          <button class="submit"><i class="icon-buscar"></i></button>
        </div>
      </form>
    </div>
