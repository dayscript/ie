        ...
        while (switching) {
          ...
          if(table !== null) {
            ...
            for (i = 1; i < (rows.length - 1); i++) {
              ...
              if(x_parts[2] !== undefined) {
                let y_parts = y.innerText.split('/');
                let x_date = new Date(x_parts[2].substring(0, 5), x_parts[1], x_parts[0]);
                if(y_parts[2] !== undefined) {
                  let y_date = new Date(y_parts[2].substring(0, 5), y_parts[1], y_parts[0]); 
