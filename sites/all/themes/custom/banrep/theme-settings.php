 ...
 */
function banrep_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['banrep_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('banrep sample setting'),
  '#default_value' => theme_get_setting('banrep_example'),
